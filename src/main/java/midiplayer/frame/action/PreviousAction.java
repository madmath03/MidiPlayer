...
public final class PreviousAction extends AbstractJssAction
  ...
  public int run(IJssController shellController, String... args) {
    return midiPlayer.moveToPreviousSong() ? AbstractJssAction.SUCCESS
