...
public class MidiPlayerFrame extends JFrame
   ...
   */
  private static final long serialVersionUID = -4975584686003343522L;
  ...
  private void setupComponents(List<Path> filesToOpen) {
    ...
    ToggleControlsNamesAction toggleControlsNamesAction =
        (ToggleControlsNamesAction) midiActionFactory
            .getAction(ToggleControlsNamesAction.DEFAULT_IDENTIFIER);
    this.displayControlsButtonNames = toggleControlsNamesAction.isSelected();
    ToggleControlsIconsAction toggleControlsIconsAction =
        (ToggleControlsIconsAction) midiActionFactory
            .getAction(ToggleControlsIconsAction.DEFAULT_IDENTIFIER);
    ...
    final ExitAction exitAction =
        (ExitAction) midiActionFactory.getAction(ExitAction.DEFAULT_IDENTIFIER);
    ...
    TransferHandler transferHandler =
        new TableRowsAndFilesTransferHandler(tablePlaylist, scrollPanePlaylist);
  ...
  static class TableRowsAndFilesTransferHandler extends TransferHandler {
     ...
     * The {@code serialVersionUID}.
     */
    private static final long serialVersionUID = -5600508916562593720L;

    /**
     * Logger.
     */
    private static final Logger LOGGER =
        Logger.getLogger(TableRowsAndFilesTransferHandler.class.getName());
     ...
     */
    private static final String ROWS_FLAVOR_MIME_TYPE =
        "application/x-java-Array;class=java.lang.reflect.Array";

    /**
     * The human displayable name of the flavor.
     */
    ...
    public boolean importData(TransferHandler.TransferSupport info) {
      ...
      } else if (info.isDataFlavorSupported(filesFlavor)
          && model instanceof MidiPlayerWithListener) {
        List<File> files;
        try {
