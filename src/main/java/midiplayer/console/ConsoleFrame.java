...
import midiplayer.console.action.CloseAction;
...
import midiplayer.console.action.RecordSaveAction;
import midiplayer.console.action.RecordStartAction;
import midiplayer.console.action.RecordStopAction;
...
import midiplayer.console.action.ZoomFitAction;
import midiplayer.console.action.ZoomInAction;
import midiplayer.console.action.ZoomOutAction;
import midiplayer.console.action.util.Serialization;
...
import midiplayer.frame.shell.LocalizedJssModel;
...
public class ConsoleFrame extends javax.swing.JFrame
  ...
  private midiplayer.console.action.util.ActionFactory consoleActionFactory;
  private midiplayer.frame.action.util.ActionFactory midiActionFactory;
   ...
   *
   * @see <a href=
   *      "http://stackoverflow.com/questions/638807/how-do-i-drag-and-drop-a-row-in-a-jtable">How
   *      do I drag and drop a row in a JTable?</a>
   * @see <a href=
   *      "http://stackoverflow.com/questions/811248/how-can-i-use-drag-and-drop-in-swing-to-get-file-path">How
   *      can I use Drag-and-Drop in Swing to get file path?</a>
   * @see <a href=
   *      "http://www.programcreek.com/java-api-examples/index.php?source_dir=jreepad-master/src/jreepad/editor/TextTransferHandler.java">TextTransferHandler</a>
   */
