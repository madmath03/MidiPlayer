 ...
 */
public final class ToggleToolbarIconsAction extends jswingshell.action.AbstractJssSwitchAction
    implements LocaleChangeListener {

  /**
   * The {@code serialVersionUID}.
   */
  private static final long serialVersionUID = -7676482425116451068L;
  ...
  private static final String ACTION_LABEL_KEY =
      "midi_player.console.action.toggle_toolbar_icons.name";
  ...
  private static final String COMMAND_BRIEF_HELP_KEY =
      "midi_player.console.action.toggle_toolbar_icons.help.short";

  private static final String COMMAND_HELP_KEY =
      "midi_player.console.action.toggle_toolbar_icons.help.long";
   ...
   */
  public static final String getHelp(ToggleToolbarIconsAction action,
    ...
    if (!commandHelpInitialized && action != null) {
      ...
      try {
        ...
        stringBuilder.append("You can switch display mode of toolbar icons as follow:")
            .append("\n");
  ...
  public ToggleToolbarIconsAction(boolean selected, ConsoleFrame frame,
