 ...
 */
public final class ToggleToolbarIconsAction extends
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ToggleToolbarIconsAction.class.getName());
  ...
  private static final String ACTION_LABEL_KEY =
      "midiplayer.console.action.toggle_toolbar_icons.name";

  private static final String COMMAND_BRIEF_HELP =
      "Toggle the frame's toolbar's icons display.";

  private static final String COMMAND_BRIEF_HELP_KEY =
      "midiplayer.console.action.toggle_toolbar_icons.help.short";

  private static final String COMMAND_HELP_KEY =
      "midiplayer.console.action.toggle_toolbar_icons.help.long";
  ...
  public static final String getHelp(ToggleToolbarIconsAction action,
    ...
    if (!commandHelpInitialized && action != null) {
      ...
      try {
        ...
        stringBuilder
            .append("You can switch display mode of toolbar icons as follow:")
            .append("\n");
