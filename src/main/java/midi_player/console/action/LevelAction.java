...
public final class LevelAction
   ...
   */
  private static final long serialVersionUID = 6289832140096851207L;
  ...
  public static final String getHelp(LevelAction action) {
    if (!commandHelpInitialized && action != null) {
      ...
      Map<IJssController.PublicationLevel, Collection<String>> argumentsByValue =
  ...
  public LevelAction(ComboBoxModel<IJssController.PublicationLevel> model) {
  ...
  protected boolean doSwitch(IJssController shellController,
      IJssController.PublicationLevel switchValue) {
  ...
  protected Collection<ComboElementAction<IJssController.PublicationLevel>> initInnerElements() {
    ...
    ArrayList<ComboElementAction<IJssController.PublicationLevel>> innerElementActions =
        new ArrayList<>(dataModel.getSize());

    for (int i = 0, n = dataModel.getSize(); i < n; i++) {
      LevelComboElementAction elementAction =
          this.new LevelComboElementAction(this, dataModel.getElementAt(i));
  ...
  public final class LevelComboElementAction
     ...
     * The {@code serialVersionUID}.
     */
    private static final long serialVersionUID = -4377912939647468809L;

    protected LevelComboElementAction(
        AbstractJssComboAction<IJssController.PublicationLevel> parentAction,
        IJssController.PublicationLevel dataItem) {
