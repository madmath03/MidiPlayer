...
public class LocaleResourceBundleWrapper implements LocaleChangeListener {
     ...
     * Logger.
     */
    private static final Logger LOGGER = Logger.getLogger(LocaleResourceBundleWrapper.class.getName());
    ...
    public LocaleResourceBundleWrapper(String baseName, ClassLoader loader, ResourceBundle.Control control) {
    ...
    public ResourceBundle getResourceBundle() {
        if (rb == null) {
            if (this.control == null && this.loader == null) {
                ...
                rb = ResourceBundle.getBundle(this.baseName, ResourceUtils.getLocale(), this.loader, this.control);
            }
        }
        return rb;
    }
     ...
     * given arguments. This is equivalent to
     * <blockquote>
     * <code>(new {@link #MessageFormat(String) MessageFormat}(pattern, 
     * ResourceUtils.getLocale())).{@link #format(java.lang.Object[], java.lang.StringBuffer, java.text.FieldPosition) format}(arguments,
     ...
     *
     * @exception IllegalArgumentException if the pattern is invalid, or if an
     * argument in the [@code arguments} array is not of the type expected
    ...
    public void setTextAndMnemonic(JComponent comp, String key, Object... arguments) throws MissingResourceException {
        try {
            String msg = getResourceBundle().getString(key);
            String txt = null;
            char mnemonic = ' ';
            ...
            LOGGER.log(Level.SEVERE, "Error occurred while setting text and menomic for component {0} and key {1}: {2}", args);
        }
    }

    public void setTextAndMnemonic(Action action, String key, Object... arguments) throws MissingResourceException {
        try {
            String msg = getResourceBundle().getString(key);
            String txt = null;
            char mnemonic = ' ';
            ...
            LOGGER.log(Level.SEVERE, "Error occurred while setting text and menomic for action {0} and key {1}: {2}", args);
        }
    }
