...
public final class LocaleAction extends jswingshell.action.AbstractJssComboAction<Locale> implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.console.action.locale.help.short";
    ...
    private static final String COMMAND_RUN_CURRENT_LOCALE_MESSAGE_KEY = "midi_player.console.action.locale.run.current_locale";

    private static final String INTERNAL_COMMAND_BRIEF_HELP = "Sets the shell's locale to ";

    private static final String INTERNAL_COMMAND_BRIEF_HELP_KEY = "midi_player.console.action.locale.internal_command.help.short";
