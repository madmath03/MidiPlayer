...
/**
 * Action to toggle the frame's toolbar's icons display.
 *
 * <p>
 ...
 */
public final class ToggleToolbarIconsAction extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {

    /**
     * Logger.
     */
    private static final Logger LOGGER = Logger.getLogger(ToggleToolbarIconsAction.class.getName());

    /**
     * This action default identifier.
     */
    public static final String DEFAULT_IDENTIFIER = "toggleToolbarIcons";

    private static final String[] IDENTIFIERS = {DEFAULT_IDENTIFIER};

    private static final String ACTION_LABEL = "Toggle toolbar icons";

    private static final String ACTION_LABEL_KEY = "midi_player.console.action.toggle_toolbar_icons.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's toolbar's icons display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.console.action.toggle_toolbar_icons.help.short";

    private static final String COMMAND_HELP_KEY = "midi_player.console.action.toggle_toolbar_icons.help.long";
     ...
     */
    public static final String getHelp(ToggleToolbarIconsAction action, IJssController shellController) {
        if (!commandHelpInitialized && action != null) {
            ...
            try {
                ...
                stringBuilder.append("You can switch display mode of toolbar icons as follow:").append("\n");
     ...
     */
    public static final String getBriefHelp(ToggleToolbarIconsAction action) {
    ...
    public ToggleToolbarIconsAction(boolean selected, ConsoleFrame frame, JssTextAreaController shellController, String... args) {
    ...
    public ToggleToolbarIconsAction(ConsoleFrame frame, JssTextAreaController shellController, String... args) {
        this(false, frame, shellController, args);
    }

    public ToggleToolbarIconsAction(ConsoleFrame frame, JssTextAreaController shellController) {
        this(false, frame, shellController, (String[]) null);
    }

    public ToggleToolbarIconsAction(ConsoleFrame frame) {
