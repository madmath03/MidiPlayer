...
/**
 * Action to paste the content of the clipboard to the current selection in a
 * shell.
 *
 * <p>
 * This action uses the {@code javax.​swing.​text.​JTextComponent.paste()}
 ...
 */
public final class PasteAction extends jswingshell.action.AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP = "Paste the content of the clipboard to the current selection.";

    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.console.action.paste.help.short";
    ...
    public PasteAction(JssTextAreaController textAreaController, JssTextAreaController shellController, String... args) {
    ...
    public PasteAction(JssTextAreaController textAreaController, JssTextAreaController shellController) {
