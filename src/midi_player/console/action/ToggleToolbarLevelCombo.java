 ...
 */
public final class ToggleToolbarLevelCombo extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "midi_player.console.action.toggle_toolbar_level_combo.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's toolbar's level combo box display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.console.action.toggle_toolbar_level_combo.help.short";

    private static final String COMMAND_HELP_KEY = "midi_player.console.action.toggle_toolbar_level_combo.help.long";
     ...
     */
    public static final String getHelp(ToggleToolbarLevelCombo action, IJssController shellController) {
        if (!commandHelpInitialized && action != null) {
            ...
            try {
                ...
                stringBuilder.append("You can switch display mode of toolbar level combo box as follow:").append("\n");
    ...
    public ToggleToolbarLevelCombo(boolean selected, ConsoleFrame frame, JssTextAreaController shellController, String... args) {
    ...
    public ToggleToolbarLevelCombo(ConsoleFrame frame, JssTextAreaController shellController, String... args) {
