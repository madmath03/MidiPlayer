 ...
 *
 * <p>
 * This action displays available commands and initializes GUI related
 * properties:</p>
 * <ul>
...
public final class HelpAction extends AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_RUN_NOT_FOUND_WARNING_KEY = "midi_player.console.action.help.run.command_not_found";
            ...
            if (args == null || args.length <= 1) {
                ...
                if (action != null) {
                    ...
                    try {
                        ...
                        LOGGER.log(Level.SEVERE, "Resource not found: \""+COMMAND_RUN_NOT_FOUND_WARNING_KEY+"\"", e);
