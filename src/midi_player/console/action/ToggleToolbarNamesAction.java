...
/**
 * Action to toggle the frame's toolbar's names display.
 *
 * <p>
 * This action is deigned for a {@link ConsoleFrame} and initializes GUI related
 * properties:</p>
 * <ul>
 ...
 */
public final class ToggleToolbarNamesAction extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {

    /**
     * Logger.
     */
    private static final Logger LOGGER = Logger.getLogger(ToggleToolbarNamesAction.class.getName());

    /**
     * This action default identifier.
     */
    public static final String DEFAULT_IDENTIFIER = "toggleToolbarNames";

    private static final String[] IDENTIFIERS = {DEFAULT_IDENTIFIER};

    private static final String ACTION_LABEL = "Toggle toolbar names";

    private static final String ACTION_LABEL_KEY = "midi_player.console.action.toggle_toolbar_names.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's toolbar's names display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.console.action.toggle_toolbar_names.help.short";

    private static final String COMMAND_HELP_KEY = "midi_player.console.action.toggle_toolbar_names.help.long";
     ...
     */
    public static final String getHelp(ToggleToolbarNamesAction action, IJssController shellController) {
        if (!commandHelpInitialized && action != null) {
            ...
            try {
                ...
                stringBuilder.append("You can switch display mode of toolbar's names as follow:").append("\n");
     ...
     */
    public static final String getBriefHelp(ToggleToolbarNamesAction action) {
    ...
    public ToggleToolbarNamesAction(boolean selected, ConsoleFrame frame, JssTextAreaController shellController, String... args) {
    ...
    public ToggleToolbarNamesAction(ConsoleFrame frame, JssTextAreaController shellController, String... args) {
        this(false, frame, shellController, args);
    }

    public ToggleToolbarNamesAction(ConsoleFrame frame, JssTextAreaController shellController) {
        this(false, frame, shellController, (String[]) null);
    }

    public ToggleToolbarNamesAction(ConsoleFrame frame) {
                ...
                for (Component toolbarComponent : toolbarButtons) {
                    if (toolbarComponent instanceof AbstractButton) {
                        ...
                        if (toolbarButton.getAction() instanceof ActionWrapper) {
                            ...
                            action.setNameAllowed(switchValue);
                        }
                    }
                }
