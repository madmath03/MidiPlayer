 ...
 * {@code avax.​imageio.​ImageIO.write(RenderedImage, String, File)} and
 * {@code java.​awt.​GraphicsConfiguration.createCompatibleImage(int, int)}, to
 * print a [@code Component} and save it to a file.</p>
 *
 * @author Mathieu Brunot
 */
public class PrintScreenAction extends jswingshell.action.AbstractThreadedJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.console.action.print_screen.help.short";

    private static final String COMMAND_HELP_KEY = "midi_player.console.action.print_screen.help.long";

    private static final String COMMAND_RUN_FILE_MANDATORY_WARNING_KEY = "midi_player.console.action.print_screen.run.file_mandatory";

    private static final String COMMAND_RUN_FILE_PATH_INVALID_KEY = "midi_player.console.action.print_screen.run.file_path_invalid";

    private static final String COMMAND_RUN_FILE_WRITING_ERROR_KEY = "midi_player.console.action.print_screen.run.file_writing_error";

    private static final String COMMAND_RUN_FILE_CLOSING_ERROR_KEY = "midi_player.console.action.print_screen.run.file_closing_error";
    ...
    public static final String getHelp(PrintScreenAction action) {
        if (!commandHelpInitialized && action != null) {
            ...
            try {
                stringBuilder.append(ResourceUtils.getMessage(COMMAND_HELP_KEY, commandIdsAsString, defaultCommandId));
