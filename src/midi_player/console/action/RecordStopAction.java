 ...
 *
 * <p>
 * This action encapsulates a {@link RecordAction} and initializes GUI related
 * properties:</p>
 * <ul>
...
public final class RecordStopAction extends AbstractAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.console.action.record_stop.help.short";
    ...
    public RecordStopAction(RecordAction recordAction) {
        ...
        this.defaultArgs = new String[]{recordAction.getDefaultCommandIdentifier(), RecordAction.RECORD_STOP};
