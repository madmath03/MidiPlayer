    ...
    public IJssAction getAction(String actionId) {
        ...
        switch (actionId) {
            ...
            case SaveScreenAction.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    saveScreenAction = new SaveScreenAction(frame.getjFileChooser(), frame, frame, controller);
            ...
            case ToggleToolbarAction.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    toggleToolbarAction = new ToggleToolbarAction(frame.isDisplayToolbar(), frame, controller);
            ...
            case ToggleToolbarIconsAction.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    toggleToolbarIconsAction = new ToggleToolbarIconsAction(frame.isDisplayToolbarButtonIcons(), frame, controller);
            ...
            case ToggleToolbarNamesAction.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    toggleToolbarNamesAction = new ToggleToolbarNamesAction(frame.isDisplayToolbarButtonNames(), frame, controller);
            ...
            case ToggleToolbarLargeIconsAction.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    toggleToolbarLargeIconsAction = new ToggleToolbarLargeIconsAction(frame.isDisplayToolbarButtonLargeIcons(), frame, controller);
            ...
            case ToggleToolbarLevelCombo.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    toggleToolbarLevelCombo = new ToggleToolbarLevelCombo(frame.isDisplayToolbarLevelCombo(), frame, controller);
            ...
            case ToggleToolbarLocaleCombo.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    toggleToolbarLocaleCombo = new ToggleToolbarLocaleCombo(frame.isDisplayToolbarLocaleCombo(), frame, controller);
            ...
            case LevelAction.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    ...
                    if (levelComboAction == null) {
                        levelComboAction = new LevelAction(IJssController.PublicationLevel.values(), controller);
