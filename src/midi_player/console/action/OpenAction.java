...
public final class OpenAction extends LoadCommandFile {
    ...
    private static final String ACTION_LABEL_KEY = "midi_player.console.action.open_command_file.name";

    private static final String COMMAND_RUN_FILE_FILTER_DESCRIPTION_KEY = "midi_player.console.action.open_command_file.run.file_filter_description";
    ...
    protected String[] extractArgumentsFromEvent(ActionEvent e) {
        ...
        if (commandIdentifier != null) {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                eventArgs = new String[]{commandIdentifier, fileChooser.getSelectedFile().getAbsolutePath()};
            }
        }
