 ...
 *
 * <p>
 * This action inherits from {@link PrintScreenAction} and initializes GUI
...
public final class SaveScreenAction extends PrintScreenAction {
    ...
    private static final String COMMAND_RUN_FILE_FILTER_DESCRIPTION_KEY = "midi_player.console.action.save_screen.run.file_filter_description";
    ...
    protected String[] extractArgumentsFromEvent(ActionEvent e) {
        ...
        if (commandIdentifiers != null && commandIdentifiers.length > 0) {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                eventArgs = new String[]{commandIdentifiers[0], fileChooser.getSelectedFile().getAbsolutePath()};
            }
        }
