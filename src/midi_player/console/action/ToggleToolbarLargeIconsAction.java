 ...
 */
public final class ToggleToolbarLargeIconsAction extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {

    /**
     * Logger.
     */
    private static final Logger LOGGER = Logger.getLogger(ToggleToolbarLargeIconsAction.class.getName());
    ...
    private static final String ACTION_LABEL_KEY = "midi_player.console.action.toggle_toolbar_large_icons.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's toolbar's large icons display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.console.action.toggle_toolbar_large_icons.help.short";

    private static final String COMMAND_HELP_KEY = "midi_player.console.action.toggle_toolbar_large_icons.help.long";
     ...
     */
    public static final String getHelp(ToggleToolbarLargeIconsAction action, IJssController shellController) {
        if (!commandHelpInitialized && action != null) {
            ...
            try {
                ...
                stringBuilder.append("You can switch display mode of toolbar large icons as follow:").append("\n");
     ...
     */
    public static final String getBriefHelp(ToggleToolbarLargeIconsAction action) {
    ...
    public ToggleToolbarLargeIconsAction(boolean selected, ConsoleFrame frame, JssTextAreaController shellController, String... args) {
    ...
    public ToggleToolbarLargeIconsAction(ConsoleFrame frame, JssTextAreaController shellController, String... args) {
        this(false, frame, shellController, args);
    }

    public ToggleToolbarLargeIconsAction(ConsoleFrame frame, JssTextAreaController shellController) {
