...
/**
 * Action to mark the start of a shell recording session.
 *
 * <p>
 * This action encapsulates a {@link RecordAction}
...
public final class RecordStartAction extends AbstractAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.console.action.record_start.help.short";
     ...
     */
    public static final String getBriefHelp(RecordStartAction action) {
    ...
    public RecordStartAction(RecordAction recordAction) {
        ...
        this.defaultArgs = new String[] {recordAction.getDefaultCommandIdentifier(), RecordAction.RECORD_START};
