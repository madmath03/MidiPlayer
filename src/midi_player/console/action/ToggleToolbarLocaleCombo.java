...
/**
 * Action to toggle the frame's toolbar's locale combo box display.
 *
 * <p>
 ...
 */
public final class ToggleToolbarLocaleCombo extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {
     ...
     */
    public static final String DEFAULT_IDENTIFIER = "toggleToolbarLocaleCombo";
    ...
    private static final String ACTION_LABEL_KEY = "midi_player.console.action.toggle_toolbar_locale_combo.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's toolbar's locale combo box display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.console.action.toggle_toolbar_locale_combo.help.short";

    private static final String COMMAND_HELP_KEY = "midi_player.console.action.toggle_toolbar_locale_combo.help.long";
     ...
     */
    public static final String getHelp(ToggleToolbarLocaleCombo action, IJssController shellController) {
        if (!commandHelpInitialized && action != null) {
            ...
            try {
                ...
                stringBuilder.append("You can switch display mode of toolbar locale combo box as follow:").append("\n");
     ...
     */
    public static final String getBriefHelp(ToggleToolbarLocaleCombo action) {
    ...
    public ToggleToolbarLocaleCombo(boolean selected, ConsoleFrame frame, JssTextAreaController shellController, String... args) {
    ...
    public ToggleToolbarLocaleCombo(ConsoleFrame frame, JssTextAreaController shellController, String... args) {
    ...
    protected boolean doSwitch(IJssController shellController, Boolean switchValue) {
        ...
        if (localeSeparator != null && localeCombo != null) {
            localeSeparator.setVisible(switchValue);
            localeCombo.setVisible(switchValue);
