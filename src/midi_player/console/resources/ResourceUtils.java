package midi_player.console.resources;

import midi_player.resources.*;
...
public final class ResourceUtils {
    ...
    private static final String CONSOLE_FRAME_RESOURCE_BUNDLE = "midi_player.console.resources.i8n.consoleframe";
     ...
     */
    private static final Locale[] APPLICATION_AVAILABLE_LOCALES = midi_player.resources.ResourceUtils.getAvailableLocales();
    ...
    public static Locale getLocale() {
        return midi_player.resources.ResourceUtils.getLocale();
    }
    ...
    public static void setLocale(Locale newLocale) {
        midi_player.resources.ResourceUtils.setLocale(newLocale);
    ...
    public static boolean addLocaleChangeListener(LocaleChangeListener listener) {
        return midi_player.resources.ResourceUtils.addLocaleChangeListener(listener);
    }
    ...
    public static boolean removeLocaleChangeListener(LocaleChangeListener listener) {
        return midi_player.resources.ResourceUtils.removeLocaleChangeListener(listener);
    }
    ...
    public static boolean containsLocaleChangeListener(LocaleChangeListener listener) {
        return midi_player.resources.ResourceUtils.containsLocaleChangeListener(listener);
    }
    ...
    protected static LocaleResourceBundleWrapper getLocaleResourceBundle() {
        if (localeResourceBundleManager == null) {
            ...
            midi_player.resources.ResourceUtils.addResourceBundleWrapper(localeResourceBundleManager);
        }
