...
public interface ReorderableTableModel extends TableModel {
     ...
     *
     * <p>
     * After the move, the row that was at index start will be at index to. This
     * method will send a tableChanged notification message to all the
     * listeners.</p>
     *
