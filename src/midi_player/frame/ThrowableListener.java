 ...
 *
 * <p>
 * It is mostly adapted for reporting of exceptions thrown (and ignored) by
 * other components: some internal components might handle some exceptions
 * (closing resources, specific return values), but in the meantime, the
 * exception can be reported to the frontend through this interface.</p>
 */
