...
public class MidiPlayerWithListener extends MidiPlayer implements ReorderableTableModel, LocaleChangeListener {
     ...
     * @see #MidiPlayer(boolean notifyOnEDT)
     */
     ...
     *
     * <p>
     * This removes a {@code ThrowableListener} that was registered.</p>
     *
     * <p>
     * If {@code listener} was added more than once to the same event source, it
     * will be notified one less time after being removed. If {@code listener}
     * is null, or was never added, no exception is thrown and no action is
     * taken.</p>
     *
     ...
     *
     * <p>
     * This removes all {@code ThrowableListener} that were registered.</p>
     */
    ...
    /**
     * Returns an unmodifiable {@code List} of all the listeners which have been
     * associated with the {@code MidiPlayer}.
     *
     * @return all of the {@code ThrowableListener}s associated with the
     * {@code MidiPlayer}.
     */
     ...
     * {@code (o==null&nbsp;?&nbsp;e==null&nbsp;:&nbsp;o.equals(e))}.</p>
     *
     * @param listener element whose presence in the listener list is to be
     * tested
    ...
    /**
     * Reports a bound excpetion message to listeners that have been registered to
     * track errors of {@code MidiPlayer}.
     *
     * <p>
     * This is merely a convenience wrapper around the more general
     * {@link #fireExceptionReceived(String)} method.</p>
     *
    ...
    /**
     * Reports a bound excpetion to listeners that have been registered to
     * track errors of {@code MidiPlayer}.
     *
     * <p>
     * This is merely a convenience wrapper around the more general
     * {@link #fireExceptionReceived(Throwable)} method.</p>
     *
    ...
    /**
     * Fires an excpetion to listeners that have been registered to
     * track errors of {@code MidiPlayer}.
     *
     * <p>
     ...
     * notified on the <i>Event Dispatch Thread</i>.</p>
     *
     * @param msg Exception message received.
     * @param thrown Exception received.
     */
    ...
    private static void fireExceptionReceived(List<ThrowableListener> listeners, String msg, Throwable thrown) {
        if (listeners != null) {
            listeners.stream().forEach((listener) -> {
     ...
     *
     * <p>
     * This removes a {@code TableModelListener} that was registered.</p>
     *
     * <p>
     * If {@code listener} was added more than once to the same event source, it
     * will be notified one less time after being removed. If {@code listener}
     ...
     *
     * <p>
     * This removes all {@code TableModelListener} that were registered.</p>
     */
     ...
     * associated with the {@code MidiPlayer}.
     *
     * @return all of the {@code TableModelListener}s associated with the
     * {@code MidiPlayer}.
     */
    ...
    /**
     * Reports a bound table model update to listeners that have been registered to
     * track updates of {@code MidiPlayer}.
     *
     * <p>
     * This is merely a convenience wrapper around the more general
     * {@link #fireTableDataChanged(TableModelEvent)} method.</p>
     */
    ...
    /**
     * Fires a table model event to listeners that have been registered to
     * track updates of {@code MidiPlayer}.
     *
     * <p>
     * No event is fired if the given event's old and new values are equal and
    ...
    /**
     * Alert listeners that have been registered to track updates of
     * {@code MidiPlayer}.
     *
     * <p>
     * No event is given to the listeners in this method.</p>
     *
     * <p>
     * If {@link #isNotifyOnEDT} is {@code true} and called off the
     * <i>Event Dispatch Thread</i> this implementation uses
    ...
    private static void fireTableDataChanged(List<TableModelListener> listeners, TableModelEvent event) {
        if (listeners != null) {
            listeners.stream().forEach((listener) -> {
     ...
     *
     * <p>
     * This removes a {@code PropertyChangeListener} that was registered.</p>
     *
     * <p>
     * If {@code listener} was added more than once to the same event source, it
     * will be notified one less time after being removed. If {@code listener}
     ...
     *
     * @return {@code true} if this {@code MidiPlayer} contained the
     ...
     *
     * <p>
     * This removes all {@code PropertyChangeListener} that were registered.</p>
     */
    ...
    private static void firePropertyChange(List<PropertyChangeListener> listeners, PropertyChangeEvent event) {
        if (listeners != null) {
            listeners.stream().forEach((listener) -> {
