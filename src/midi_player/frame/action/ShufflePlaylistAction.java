 ...
 */
public final class ShufflePlaylistAction extends AbstractJssAction implements LocaleChangeListener, PropertyChangeListener {
    ...
    public ShufflePlaylistAction(MidiPlayer midiPlayer, IJssController shellController, String... args) {
