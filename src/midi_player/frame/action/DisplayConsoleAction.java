 ...
 */
public final class DisplayConsoleAction extends AbstractJssSwitchAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.action.display_console.help.short";
