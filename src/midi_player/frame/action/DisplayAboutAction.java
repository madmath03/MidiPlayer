...
public final class DisplayAboutAction extends AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.action.display_about.help.short";

    private static final String COMMAND_HELP_KEY = "midi_player.action.display_about.help.long";

    private static final String ABOUT_SCREEN_TITLE_KEY = "midi_player.action.display_about.screen.title";

    private static final String ABOUT_SCREEN_MESSAGE_KEY = "midi_player.action.display_about.screen.message";
    ...
    public int run(IJssController shellController, String... args) {
        ...
        JOptionPane.showMessageDialog(midiPlayerController.getFrame(), 
                ...
                ResourceUtils.createImageIcon(MidiPlayerFrame.ICON_KEY, MidiPlayerFrame.ICON_LABEL, "128x128")
        );
