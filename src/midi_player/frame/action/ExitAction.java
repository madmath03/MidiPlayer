 ...
 *
 * <p>
 * This action inherits from the standard {@code jswingshell.action.ExitAction}
...
public final class ExitAction extends AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_RUN_INVALID_RETURN_CODE_WARNING_KEY = "midi_player.action.exit.run.invalid_return_code";
            ...
            try {
                ...
                if (shellController != null) {
                    ...
                    try {
                        ...
                        LOGGER.log(Level.SEVERE, "Resource not found: \"" + COMMAND_RUN_INVALID_RETURN_CODE_WARNING_KEY + "\"", e1);
