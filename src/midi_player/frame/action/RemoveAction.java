 ...
 */
public final class RemoveAction extends AbstractJssAction implements LocaleChangeListener, PropertyChangeListener {
    ...
    public static final String getHelp(RemoveAction action) {
        if (!commandHelpInitialized && action != null) {
            ...
            try {
                ...
                stringBuilder.append("\n\t").append(commandIdsAsString).append(" [integer1] [integer2] [integer3] [integer4] ... ");
            }
        ...
        if (commandIdentifier != null && e != null) {
            ...
            if (tablePlaylist != null) {
                ...
                if (selectedRows != null && selectedRows.length > 0) {
                    ...
                    for(int rowIndex = selectedRows.length -1, argIndex = 1; 
                            rowIndex >= 0; rowIndex--, argIndex++) {
