 ...
 */
public final class ToggleControlsLargeIconsAction extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {

    /**
     * Logger.
     */
    private static final Logger LOGGER = Logger.getLogger(ToggleControlsLargeIconsAction.class.getName());
    ...
    private static final String ACTION_LABEL_KEY = "midi_player.action.toggle_controls_large_icons.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's controls's large icons display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.action.toggle_controls_large_icons.help.short";

    private static final String COMMAND_HELP_KEY = "midi_player.action.toggle_controls_large_icons.help.long";
     ...
     */
    public static final String getHelp(ToggleControlsLargeIconsAction action, IJssController shellController) {
        if (!commandHelpInitialized && action != null) {
            ...
            try {
                ...
                stringBuilder.append("You can switch display mode of controls large icons as follow:").append("\n");
    ...
    public ToggleControlsLargeIconsAction(boolean selected, MidiPlayerFrame frame, JssTextAreaController shellController, String... args) {
    ...
    public ToggleControlsLargeIconsAction(MidiPlayerFrame frame, JssTextAreaController shellController, String... args) {
        this(false, frame, shellController, args);
    }

    public ToggleControlsLargeIconsAction(MidiPlayerFrame frame, JssTextAreaController shellController) {
