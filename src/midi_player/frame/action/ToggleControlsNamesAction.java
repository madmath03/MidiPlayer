...
/**
 * Action to toggle the frame's controls' names display.
 *
 * <p>
 ...
 */
public final class ToggleControlsNamesAction extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {
     ...
     */
    public static final String DEFAULT_IDENTIFIER = "toggleControlsNames";
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.action.toggle_controls_names.help.short";

    private static final String COMMAND_HELP_KEY = "midi_player.action.toggle_controls_names.help.long";
     ...
     */
    public static final String getHelp(ToggleControlsNamesAction action, IJssController shellController) {
        if (!commandHelpInitialized && action != null) {
            ...
            try {
                ...
                stringBuilder.append("You can switch display mode of controls' names as follow:").append("\n");
     ...
     */
    public static final String getBriefHelp(ToggleControlsNamesAction action) {
    ...
    public ToggleControlsNamesAction(boolean selected, MidiPlayerFrame frame, JssTextAreaController shellController, String... args) {
    ...
    public ToggleControlsNamesAction(MidiPlayerFrame frame, JssTextAreaController shellController, String... args) {
