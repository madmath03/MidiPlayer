 ...
 */
public final class PlayAction extends AbstractJssAction implements LocaleChangeListener, PropertyChangeListener {
    ...
    private static final String COMMAND_RUN_FILE_PATH_INVALID_KEY = "midi_player.action.play.run.file_path_invalid";
    ...
    public static final String getHelp(PlayAction action) {
        if (!commandHelpInitialized && action != null) {
            ...
            try {
                ...
                stringBuilder.append("\n").append("You can specify the song to play by giving the song index in playlist as follow:");
