package midi_player.frame.action.util;
    ...
    public IJssAction getAction(String actionId) {
        ...
        switch (actionId) {
            case AddAction.DEFAULT_IDENTIFIER:
                AddAction addAction;
                if (action == null) {
                    addAction = new AddAction(midiPlayerFrame.getFileChooser(), midiPlayerFrame, midiPlayer, midiPlayerController);
                    action = addAction;
            ...
            case ToggleControlsNamesAction.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    toggleControlsNamesAction = new ToggleControlsNamesAction(midiPlayerFrame.isDisplayControlsButtonNames(), midiPlayerFrame, midiPlayerController);
            ...
            case ToggleControlsIconsAction.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    toggleControlsIconsAction = new ToggleControlsIconsAction(midiPlayerFrame.isDisplayControlsButtonIcons(), midiPlayerFrame, midiPlayerController);
            ...
            case ToggleControlsLargeIconsAction.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    toggleControlsLargeIconsAction = new ToggleControlsLargeIconsAction(midiPlayerFrame.isDisplayControlsButtonLargeIcons(), midiPlayerFrame, midiPlayerController);
            ...
            case LocaleAction.DEFAULT_IDENTIFIER:
                ...
                if (action == null) {
                    localeAction = new LocaleAction(ResourceUtils.getAvailableLocales(), midiPlayerController);
                    action = localeAction;
                    addToShell(midiPlayerController, action);
