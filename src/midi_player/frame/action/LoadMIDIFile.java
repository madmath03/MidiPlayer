...
public class LoadMIDIFile extends AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "midi_player.action.load_midi_file.help.short";

    private static final String COMMAND_HELP_KEY = "midi_player.action.load_midi_file.help.long";

    private static final String COMMAND_RUN_FILE_MANDATORY_WARNING_KEY = "midi_player.action.load_midi_file.run.file_mandatory";

    private static final String COMMAND_RUN_FILE_NOT_READABLE_KEY = "midi_player.action.load_midi_file.run.file_not_readable";

    private static final String COMMAND_RUN_FILE_PATH_INVALID_KEY = "midi_player.action.load_midi_file.run.file_path_invalid";
    ...
    public LoadMIDIFile(MidiPlayer midiPlayer, String name, Icon icon, IJssController shellController, String... args) {
    ...
    public LoadMIDIFile(MidiPlayer midiPlayer, String name, IJssController shellController, String... args) {
            ...
            if (!Files.isReadable(path) || !filesToLoad.add(path)) {
                ...
                if (Files.exists(path)) {
                    ...
                    try {
                        ...
                        LOGGER.log(Level.SEVERE, "Resource not found: \"" + COMMAND_RUN_FILE_NOT_READABLE_KEY + "\"", e);
                    ...
                    try {
                        ...
                        LOGGER.log(Level.SEVERE, "Resource not found: \"" + COMMAND_RUN_FILE_PATH_INVALID_KEY + "\"", e);
